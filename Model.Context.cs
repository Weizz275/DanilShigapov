...
namespace Shigapov_glazki
{
    ...
    public partial class ShigapovEntitiess : DbContext
    {
        public ShigapovEntitiess()
            : base("name=ShigapovEntitiess")
        {
        }

        private static ShigapovEntitiess _context;

        public static ShigapovEntitiess GetContext()
        {
            if (_context == null)
                _context = new ShigapovEntitiess();
            return _context;
        }
